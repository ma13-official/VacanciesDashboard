...
for path in [Local.logs_path, Local.single_jsons_path, Local.group_jsons_path, Local.errors_path, Local.captcha,
             Local.unexpected_error, Local.captcha_images, S3_paths.logs_path, S3_paths.vacancies_jsons_path,
             S3_paths.group_jsons_path, Logger_settings.default]:
